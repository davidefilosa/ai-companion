...
const formSchema = z.object({
  ...
  instructions: z
    .string()
    .min(200, { message: "Insctructions require at least 200 charaters" }),
  seed: z
    .string()
    .min(200, { message: "Seed requires at least 200 charaters" }),
              ...
              render={({ field }) => (
                <FormItem className="col-span-2 md:col-span-1">
                  ...
                  <FormControl>
                    <Input
                      disabled={isLoading}
                      placeholder="Portuguese professional footballer widely regarded as one of the greatest players of all time"
                      {...field}
                    />
                  </FormControl>
                  <FormDescription>
